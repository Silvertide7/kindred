...
public final class ClientPacketHandler {
    public static void onRosterSync(S2CRosterSync payload, Supplier<NetworkEvent.Context> context) {
    ...
    public static void onBindCandidateResult(S2CBindCandidateResult payload, Supplier<NetworkEvent.Context> context) {
     ...
     */
    public static void onHoldStart(S2CHoldStart payload, Supplier<NetworkEvent.Context> context) {
     ...
     */
    public static void onHoldStop(S2CHoldStop payload, Supplier<NetworkEvent.Context> context) {
